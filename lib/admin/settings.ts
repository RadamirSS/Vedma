...
export const DEFAULT_SITE_SETTINGS: SiteSettingsShape = {
  ...
  footer: {
    ...
    disclaimer:
      "Услуги и товары на сайте относятся к эзотерическим, консультационным и трансформационным практикам. Они не заменяют профессиональную помощь. 18+.",
  ...
  legalPages: {
    ...
    disclaimerText:
      "Эзотерические и трансформационные практики не заменяют медицинскую, юридическую и иную профессиональную помощь."
  },
  currencies: {
    primary: "RUB",
    secondary: "USD"
