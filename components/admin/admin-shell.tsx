...
const navItems: Array<{ href: Route; label: string; roles: Role[] }> = [
  { href: "/admin/dashboard", label: "Дашборд", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/products", label: "Товары", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/services", label: "Услуги", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/orders", label: "Заказы", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/requests", label: "Заявки", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/payments", label: "Платежи", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/customers", label: "Клиенты", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/media", label: "Медиа", roles: ["ADMIN", "MANAGER"] },
  { href: "/admin/reviews", label: "Отзывы", roles: ["ADMIN", "MANAGER"] },
